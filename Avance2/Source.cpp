...
int n = 0;
string Usuario, Contraseña, Comercio, UsuariosBin;
float producto;
//Lista ligada Usuarios
string usu, nomcom, cont, comer, ali; int numcom; bool adm, newus;
...
void NuevoUsuario();
void agregar_usuario(usuarios*& lista1, string usu, string nomcom, string cont, string comer, string ali, int numcom, bool adm, bool newus);
//usuario
...
BOOL CALLBACK WindowProc1(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
        ...
        case WM_COMMAND:
            ...
            case IDC_BUTTON1:
                ...
                GetWindowText(g1, (LPWSTR)Usuario.c_str(), sizeof(Usuario));
                GetWindowText(g2, (LPWSTR)Contraseña.c_str(), sizeof(Contraseña));
                UsuValid = false;
                actual = lista1;
                j = 0;
...
BOOL CALLBACK RegistroUsuario(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_INITDIALOG:
        ...
        h_edit = GetDlgItem(hwnd, IDC_EDIT1);
        SetWindowText(h_edit,L"usuario");

        h_edit = GetDlgItem(hwnd, IDC_EDIT2);
        SetWindowText(h_edit, L"contraseña");

        h_edit = GetDlgItem(hwnd, IDC_EDIT3);
        SetWindowText(h_edit, L"Comercio");
    ...
    case WM_COMMAND:
        ...
        {
        case IDC_BUTTON1:
            GetWindowText(g1, (LPWSTR)usu.c_str(), sizeof(usu));
            GetWindowText(g2, (LPWSTR)cont.c_str(), sizeof(cont));
            GetWindowText(g3, (LPWSTR)comer.c_str(), sizeof(comer));
...
void agregar_usuario(usuarios*& lista1, string usu, string nomcom, string cont, string comer, string ali, int numcom, bool adm, bool newus) {
    ...
    nuevo_usuario->nomusuario = usu;
    nuevo_usuario->nombrecom = nomcom;
    nuevo_usuario->contraseña = cont;
    nuevo_usuario->comercio = comer;
    nuevo_usuario->alias = ali;
